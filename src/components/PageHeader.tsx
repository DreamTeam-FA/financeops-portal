    ...
    <div className={`${bgClass} text-white shrink-0 transition-colors`}>
      <div className="flex flex-wrap items-center justify-between px-4 pt-3 pb-2 gap-2">
        <div className="flex items-center gap-2.5">
          ...
          {/* Auth Status Badge */}
          {googleUser ? (
            <span className="hidden lg:inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-100 text-[11px] font-medium border border-emerald-400/30">
              <CheckCircle2 className="w-3 h-3 text-emerald-300" />
              2-Way Google Sync Active
            </span>
          ) : (
            <button
