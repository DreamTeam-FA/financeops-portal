  ...
  const sections = [
    {
      ...
      items: [
        ...
        { page: "statements",  icon: "📄", label: "Bank Stmts" },
        { page: "calendar",    icon: "📅", label: "Calendar" },
        { page: "ap-calendar", icon: "🗓", label: "Payables Cal." },
        { page: "headleys",    icon: "🍽️", label: "Headleys" },
        { page: "fouryr-payroll", icon: "👥", label: "4YR Payroll" },
        { page: "cc-expenses", icon: "💳", label: "CC Expenses" },
        { page: "service-limits", icon: "⚙️", label: "Svc Limits" },
      ],
    },
    {
      label: "Entities",
      items: [
        { page: "rubys",    icon: "🍎", label: "Ruby's" },
        { page: "ti",       icon: "🏢", label: "TI" },
        { page: "msdx",     icon: "🏥", label: "MSDx" },
        { page: "curcumin", icon: "🌿", label: "CurcuminPRO" },
        { page: "ziglar",   icon: "⚡", label: "Ziglar" },
        { page: "fouryr",   icon: "📋", label: "4YR" },
      ],
    },
    {
      label: "Workspace",
...
const PortalContent: React.FC = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "doc-scanner":
        return <DocScannerPage onBack={() => setCurrentPage("workspace-tools")} />;
      case "cc-expenses":
  ...
  return (
    <div
      ...
      style={theme === "dark" ? { background: "#0a0a0a" } : {}}
    >
      {/* Desktop Sidebar */}
