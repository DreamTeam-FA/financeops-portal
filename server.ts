...
app.post("/api/cc-expense/export-sheet", async (req, res) => {
  ...
  try {
    ...
    const dashValues: any[][] = [
      ...
      E(W),
      // Row 2: meta
      ["Last Updated", lastUpdated, "", "Date Range", dateRange || "", ...E(W - 5)],
      // Row 3: blank
      E(W),
      // Row 4: KPI labels
      ["TOTAL CC EXPENSES", "", "", "", "TOTAL TRANSACTIONS", "", "", "", "ACTIVE COMPANIES", "", ""],
      // Row 5: KPI values
      [`=SUM('Raw Data'!J2:J)`, "", "", "", `=COUNTA('Raw Data'!B2:B)`, "", "", "", String(N), "", ""],
    ...
    for (let i = 0; i < N; i++) {
      ...
      dashValues.push([
        co,
        `=SUMIF('Raw Data'!G:G,"${co}",'Raw Data'!J:J)`,
    ...
    // Spacer + note
    dashValues.push(E(W));
    dashValues.push([...E(4), `Generated by FinanceOps Portal. Use "Weekly Breakdown" tab and filter the Week column to view a specific week.`, ...E(W - 5)]);
